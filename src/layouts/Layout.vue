    ...
    <div class="h-screen flex flex-col">
        ...
        <div class="flex-1 flex">
            <aside class=" w-56  bg-blue-800 p-2">
                ...
                <RouterLink :to="{ name: 'reuniones.create' }"
                    class="py-4 mb-4 flex justify-center items-center text-white font-semibold bg-blue-500/50 hover:bg-blue-500 ">
                ...
                <RouterLink :to="{ name: 'reuniones.index' }"
                    class="py-4 flex justify-center items-center text-white font-semibold bg-blue-500/50 hover:bg-blue-500 ">
                    <svg class="w-6 h-6 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
